...
local mappings = {
    ...
    --["i<TAB>"]     = {"v:lua.tab_complete()", silent = true, noremap = true, expr = true},
    --["s<TAB>"]     = {"v:lua.tab_complete()", silent = true, noremap = true, expr = true},
    --["i<S-TAB>"]     = {"v:lua.s_tab_complete()", silent = true, noremap = true, expr = true},
    --["s<S-TAB>"]     = {"v:lua.s_tab_complete()", silent = true, noremap = true, expr = true},
}
